...
struct Spinner: View {
    ...
    var body: some View {
        ZStack {
            ...
            ZStack {
                SpinnerCircle(start: spinnerStart, end: spinnerEndS2S3, rotation: rotationDegreeS3, color: .blue.opacity(0.3))

                SpinnerCircle(start: spinnerStart, end: spinnerEndS2S3, rotation: rotationDegreeS2, color: .green.opacity(0.5))

                SpinnerCircle(start: spinnerStart, end: spinnerEndS1, rotation: rotationDegreeS1, color: .green.opacity(0.2))
